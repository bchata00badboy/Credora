...
// Mapa de rutas -> funciones (versión comercio: archivos *_Com.html)
const controladores = {
    'Main_Parts/main_homeCom.html': iniciarInicio,
    'Main_Parts/main_profileCom.html': iniciarPerfil,
    'Main_Parts/main_notifCom.html': iniciarNotificaciones,
    'Main_Parts/main_transf1Com.html': iniciarTransferencias,
    'Main_Parts/main_movCom.html': iniciarMovimientos,
    'Main_Parts/main_mov_dataCom.html': iniciardatamov,
    'Main_Parts/main_mov_dataCom.html': iniciardatamov,
    'Main_Parts/main_kycCom.html': iniciarKYC,
    'Main_Parts/main_configCom.html': iniciarConfiguracion,
    'Main_Parts/main_educCom.html': iniciarEducacion
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    moveOverlaysToBody();
    bindModalHandlers();
    cargarVista('Main_Parts/main_homeCom.html');
});
        ...
        btnConfirmar.onclick = async () => {
            ...
            try {
                ...
                if (respuesta) {
                    ...
                    // window.cargarVista('Main_Parts/main_homeCom.html'); 
    ...
    if(formFinalizar) {
        formFinalizar.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                window.cargarVista('Main_Parts/main_profileCom.html');
            } catch (err) {
    ...
    const ejecutarTransferencia = async () => {
        ...
        try {
            ...
            if (res) {
                ...
                if(window.cargarVista) window.cargarVista('Main_Parts/main_homeCom.html');
            }
        } catch (e) {
...
// ------------------------------------------------------
    ...
    if(btnKycLink) {
        btnKycLink.onclick = (e) => {
            e.preventDefault();
            if (window.cargarVista) window.cargarVista('Main_Parts/main_kycCom.html');
        };
    }
}
